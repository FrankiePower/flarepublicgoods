    ...
    <div className='p-6 space-y-8'>
      ...
      <section className='space-y-4'>
        ...
        <motion.div
          ...
          animate='animate'
          className='p-6 bg-red-100 rounded-lg text-center border-2 border-red-300'
        >
          ✨ Glowing Element ✨
        </motion.div>
      </section>
      ...
      <section className='space-y-4'>
        ...
        <motion.div
          ...
          initial='hidden'
          animate='visible'
          className='p-6 bg-gradient-to-r from-red-400 to-red-400 rounded-lg text-white text-center'
        >
          🎯 Scaled In Element
        </motion.div>
      </section>
